...
class S3ServerRoutesTest {
    ...
    @Test
    fun `operational upload limiter rejects saturated uploads and records counters`() =
        runBlocking {
    ...
    @Test
    fun `operational completion limiter rejects saturated completions and records counters`() =
        runBlocking {
    ...
    @Test
    fun `bounded complete xml reader rejects declared oversized body`() =
        testApplication {
            application {
                routing {
                    post("/bounded") {
