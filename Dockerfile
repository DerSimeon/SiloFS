...
RUN useradd --create-home --shell /bin/bash silofs \
    && mkdir -p /var/lib/silofs/data \
    && chown -R silofs:silofs /var/lib/silofs
WORKDIR /home/silofs
COPY --from=builder --chown=silofs:silofs /home/gradle/src/server/build/install/silofs /home/silofs/silofs
USER silofs
