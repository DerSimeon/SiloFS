...
data class SigV4Authorization(
    ...
    companion object {
        fun parse(header: String?): SigV4Authorization {
            ...
            val credential = fields["Credential"]
                ?: throw S3Errors.authorizationHeaderMalformed("Missing Credential field")
            val signedHeadersRaw = fields["SignedHeaders"]
...
object SigV4Verifier {
    ...
    fun signingKey(secretAccessKey: String, dateStamp: String, region: String, service: String): ByteArray {
