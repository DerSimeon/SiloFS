...
object ETagMatcher {
     ...
     */
    fun anyEntryMatches(headerValue: String, etag: String?): Boolean {
     ...
     */
    fun ifMatchSatisfied(headerValue: String?, etag: String?): Boolean {
     ...
     */
    fun ifNoneMatchSatisfied(headerValue: String?, etag: String?): Boolean {
        if (headerValue == null) return true
        return !anyEntryMatches(headerValue, etag)
    }
}
